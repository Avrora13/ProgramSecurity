...
namespace ProgramSecurity {
    ...
    public partial class Database5DataSet : global::System.Data.DataSet {
        ...
        public partial class ПользователиDataTable : global::System.Data.TypedTableBase<ПользователиRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ПользователиRow AddПользователиRow(string Login, string Password, bool Admin) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ПользователиRow FindByLogin(string Login) {
        ...
        public partial class ПользователиRow : global::System.Data.DataRow {
            ...
            public bool Admin {
                get {
                    try {
                        return ((bool)(this[this.tableПользователи.AdminColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Admin\' в таблице \'Пользователи\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableПользователи.AdminColumn] = value;
                }
            }
            ...
            public bool IsAdminNull() {
                return this.IsNull(this.tableПользователи.AdminColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetAdminNull() {
                this[this.tableПользователи.AdminColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace ProgramSecurity.Database5DataSetTableAdapters {
    ...
    public partial class ПользователиTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Пользователи` WHERE ((`Login` = ?) AND ((? = 1 AND `Password` IS NUL" +
                "L) OR (`Password` = ?)) AND ((? = 1 AND `Admin` IS NULL) OR (`Admin` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Пользователи` (`Login`, `Password`, `Admin`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Пользователи` SET `Login` = ?, `Password` = ?, `Admin` = ? WHERE ((`Login" +
                "` = ?) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND " +
                "`Admin` IS NULL) OR (`Admin` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ProgramSecurity.Properties.Settings.Default.Database5ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Login, [Password], Admin FROM Пользователи";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO `Пользователи` (`Login`, `Password`, `Admin`) VALUES (?, ?, ?)";
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Admin", global::System.Data.OleDb.OleDbType.Boolean, 2, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Admin", global::System.Data.DataRowVersion.Current, false, null));
            this._commandCollection[2] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Login, [Password], Admin FROM Пользователи";
        ...
        public virtual int Fill(Database5DataSet.ПользователиDataTable dataTable) {
        ...
        public virtual Database5DataSet.ПользователиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database5DataSet.ПользователиDataTable dataTable = new Database5DataSet.ПользователиDataTable();
        ...
        public virtual int FillBy(Database5DataSet.ПользователиDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy1(Database5DataSet.ПользователиDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database5DataSet.ПользователиDataTable dataTable) {
        ...
        public virtual int addNewUser(string Login, string Password, bool Admin) {
